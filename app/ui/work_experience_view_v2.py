...
from .custom_components import InputTag
            ...
            Form(
                Fieldset(
                    ...
                    Div(
                         ...
                         # This button now reloads the whole tab, effectively cancelling any changes
                         A(cancel_button_text, href=cancel_action, cls="btn btn-secondary mt-4"),
